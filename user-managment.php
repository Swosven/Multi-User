	...
	public function mmCheckPermissions()
	{
		...
		if ($current_file == "settings.php") {
		  ...
		  if ($this->mmUserFile('SETTINGS') == "no") {
			  ...
			  $settings_footer = "$(\"a\").remove(\":contains('". i18n_r('GENERAL_SETTINGS') ."')\");"; // ### General Settings
		  }
				else {
				   $settings_menu ="";
				   $settings_footer = "";
		...
		if ($current_file == "backups.php") {
		  ...
		  if ($this->mmUserFile('BACKUPS') == "no") {
			  ...
			  $backups_footer = "$(\"a\").remove(\":contains('". i18n_r('BAK_MANAGEMENT') ."')\");"; // ### Backup Management
		  }
				else {
				   $backups_menu ="";
				   $backups_footer = "";
		...
		if ($current_file == "plugins.php") {
		  ...
		  if ($this->mmUserFile('PLUGINS') == "no") {
			  ...
			  $plugins_footer = "$(\"a\").remove(\":contains('". i18n_r('PLUGINS_MANAGEMENT') ."')\");"; // ### Plugin Management
		  }
				else {
				   $plugins_menu ="";
				   $plugins_footer = "";
		...
		if ($current_file == "pages.php") {
		  ...
		  if ($this->mmUserFile('PAGES') == "no") {
			  ...
			  $pages_footer = "$(\"a\").remove(\":contains('". i18n_r('PAGE_MANAGEMENT') ."')\");"; // ### Page Management
		  }
				else {
				   $pages_menu ="";
				   $pages_footer = "";
		...
		if ($current_file == "support.php") {
		 ...
		 if ($this->mmUserFile('SUPPORT') == "no") {
			  ...
			  $support_footer = "$(\"a\").remove(\":contains('". i18n_r('SUPPORT') ."')\");"; // ### Support
		  }
				else {
					$support_menu = "";
					$support_footer = "";
		...
		if ($current_file == "upload.php") {
		  ...
		  if ($this->mmUserFile('FILES') == "no") {
			  ...
			  $files_footer = "$(\"a\").remove(\":contains('". i18n_r('FILE_MANAGEMENT') ."')\");"; // ### File Management
		  }
				else {
					 $files_menu = "";
					 $files_footer = "";
		...
		if ($current_file == "theme.php") {
		 ...
		 if ($this->mmUserFile('THEME') == "no") {
			  ...
			  $theme_footer = "$(\"a\").remove(\":contains('". i18n_r('THEME_MANAGEMENT') ."')\");"; // ### Theme Management
		  }
				else {
					$theme_menu = "";
					$theme_footer = "";
